...
u64 getSjForN(u64 j, u64 n)
{
    ...
    for (u64 k = n + 1;; k++)
    {
        ...
        std::cout << "mianownik: " << std::hex << std::uppercase << std::setfill('0') << std::setw(8) << denominator << '\n';
        result += curPart;
        std::cout << "     suma: " << std::hex << std::uppercase << std::setfill('0') << std::setw(8) << result << "\n\n";
...
int main()
{
    std::cout << std::hex << std::uppercase << std::setfill('0') << std::setw(8) << getSjForN(5, 32) << '\n';
